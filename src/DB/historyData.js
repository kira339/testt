export const tableData = [
  {
    ...
    actualMessage:
      "test: Text Y to activate your registration for the account at hello Ave. Msg&Data rates may apply. Text Stop to cancel, HELP for help",
  },
  {
